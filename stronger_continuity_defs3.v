...
Proof.
  ...
  allrw @isprogram_eq.
  allrw @fold_subst.
  pose proof (ceq (exist _ t ps0)) as h.
  allsimpl; auto.
Qed.
...
Proof.
  ...
  allrw @isprogram_eq.
  allrw @fold_subst.
  pose proof (ceq2 (exist _ t ps0)) as h.
  allsimpl; auto.
Qed.
...
Proof.
  ...
  - right; left.
    ...
    exists (exist _ a comp3) (exist _ e comp2); allsimpl; dands; auto.
  - right; right.
    applydup @preserve_program_exc2 in comp2; allrw @isprogram_eq; repnd; auto.
    exists i3 (exist _ a comp5) (exist _ e comp4); allsimpl; dands; auto.
Qed.
...
Proof.
  ...
  - applydup @preserve_program_exc2 in h1; allrw @isprogram_eq; auto; repnd.
    exists (exist _ a h2) (exist _ e h0); simpl; auto.
