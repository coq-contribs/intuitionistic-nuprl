...
Definition left_injection_or_decide_not_well_formed := "left injection or decide not well-formed".
Definition right_injection_or_decide_not_well_formed := "right injection or decide not well-formed".
  ...
  match arg1c with
    | NInl =>
      match (arg1bts, btsr) with
        ...
        | _ => cfailure left_injection_or_decide_not_well_formed t
      end
    | NInr =>
      match (arg1bts, btsr) with
        | ([bterm [] u] , [bterm [v1] t1, bterm [v2] t2]) =>
          csuccess (apply_bterm (bterm [v2] t2) [u])
        | _ => cfailure right_injection_or_decide_not_well_formed t
      end
