...
Proof.
  ...
  - pose proof (Z_noteq_dec z z0) as h.
    dorn h; subst; tcsp.
    right; intro k; inversion k; subst; omega.

  - pose proof (String.string_dec s s0) as h.
    dorn h; subst; tcsp.
  ...
  - pose proof (deq_nat n n0) as h.
    dorn h; subst; tcsp.
    right; intro x; inversion x; omega.

  - pose proof (get_dp dc g g0) as h; dorn h; subst; sp.
    right; intro k; inversion k; sp.

  - pose proof (get_dt dc g g0) as h; dorn h; subst; sp.
    right; intro k; inversion k; sp.
Qed.
